...
public class SetSatInstance
{
	...
	//The method to check whether the new literal already exist in the 3SAT instance
		...
		//Convert Array of String to Array of SatClause
		// getString() from tempList to get the String
		...
		{		
			...
			//System.out.println("Size of the SAT instances is : " + satList.size());
		}
		...
		public static void main(String... args) 
		  { 
			  ...
			  //Find unsatify clauses 
			  //Print list of unSatisfied clauses
			  ...
			  else
			  {
				  ...
				  {	  
					  ...
					  SatAlgo1.booToString();				  
					  // Recheck how many clause satisfied				  
